...
{
    /// <inheritdoc />
    public partial class Updates : Microsoft.EntityFrameworkCore.Migrations.Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Appointments",
                newName: "IX_Appointments_ServiceProviderId");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableSmsNotifications = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceProviderServices", x => new { x.ServiceProvidersId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_ServiceProviderServices_ServiceProviders_ServiceProvidersId",
                        column: x => x.ServiceProvidersId,
                        principalTable: "ServiceProviders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceProviderServices_Services_ServicesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceProviderServices_ServicesId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Appointments",
                newName: "IX_Appointments_SalonServiceId");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalonServiceProducts", x => new { x.SalonServiceId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_SalonServiceProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalonServiceProducts_SalonServices_SalonServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalonServiceProducts_ProductId",
                table: "SalonServiceProducts",
                column: "ProductId");
